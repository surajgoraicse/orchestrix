...
Orchestrix is composed of several key components that work together to schedule and execute tasks. Here's a brief overview of each component:
...
Clients can interact with the Orchestrix cluster to schedule tasks and query their status using HTTP requests:
